...
Menu, Tray, add ;separator
Menu, Tray, Add , Restart`tCtrl+Shift+R, MenuFileRestart ;add an item named Restart that restarts the script
Menu, Tray, Add , Suspend`tCtrl+Shift+S, MenuFileSuspend ;add an item named Suspend that suspends the script
Menu, Tray, add ;separator
...
IfExist, %A_ScriptDir%\icons\GreenArrow.ico
{
	Menu, Tray, Icon , %A_ScriptDir%\icons\GreenArrow.ico,, 1
}
...
if A_IsSuspended = 0
{
	...
	IfExist, %A_ScriptDir%\icons\GreenArrow.ico
	{
		Menu, Tray, Icon, %A_ScriptDir%\icons\GreenArrow.ico ;changing tray icon
	}
...
else
{
	...
	IfExist, %A_ScriptDir%\icons\RedArrow.ico
	{
		Menu, Tray, Icon, %A_ScriptDir%\icons\RedArrow.ico ;changing tray icon
	}
...
Gui, HelpGui: Add, Text, y+30 w100, Website:
Gui, HelpGui: Add, Link, x+10, <a href="https://github.com/Khalid-Fawzy/double-click-repair-tool">GitHub Page</a> ;Khalid.Fawzy@yahoo.com
Gui, HelpGui: Add, Text, xs y+10 w100, Author:
